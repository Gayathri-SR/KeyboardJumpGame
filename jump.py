...
icon=pygame.image.load('bird icon.png')
pygame.display.set_icon(icon)
background = pygame.image.load('welcomebird.png')
background = pygame.transform.scale(background, (WIDTH, HEIGHT))  #scale image 
font = pygame.font.Font('Pokemon Solid.ttf', 40)
...
def new_word():
    ...
    x_cor = random.randint(300,700)     #random x-cor between 300-700
    y_cor = 200 
    word_speed += 0.05
    yourword = ''
...
font_name = pygame.font.match_font('Pokemon Solid.ttf')
...
def game_front_screen():
    ...
    if not game_over :
        ...
        draw_text(gameDisplay, "Keyboard Jump Game", 60, WIDTH / 2, HEIGHT/4)
